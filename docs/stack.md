...
| Worktrunk (`wt`) | Gestion de ramas y worktrees. | El comando `/branch` crea un worktree aislado y abre una sesion limpia de OpenCode alli. |
...
3. Cuando una conversacion ya tiene un plan claro, `/branch` usa Worktrunk para crear un worktree dedicado.
